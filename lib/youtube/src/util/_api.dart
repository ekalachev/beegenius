class ApiHelper {
  ...
  static String youtubeV3Path = 'youtube/v3';
  ...
  Uri trendingUri({required String regionCode}) {
    ...
    Uri url = Uri.https(baseURL, "$youtubeV3Path/videos", options);
    return url;
  }
  ...
  Uri searchUri(
    ...
    print(options);
    Uri url = Uri.https(baseURL, "$youtubeV3Path/search", options);
    return url;
  }
